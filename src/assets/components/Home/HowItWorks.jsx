...
const steps = [
  {
    ...
    description: "User selects Area of Interest on the map for analysis.",
  },
  {
    title: "Fetch Satellite Data",
    icon: <CloudDownload className="w-8 h-8 text-green-600" />,
    description: "System automatically pulls recent satellite imagery of AOI.",
  },
  {
    title: "AI Detection",
    icon: <BrainCog className="w-8 h-8 text-purple-600" />,
    description: "AI identifies drainage layout, changes, and potential flood risk.",
  },
  {
    title: "Dashboard Insights",
    icon: <BarChart className="w-8 h-8 text-yellow-600" />,
    description: "Interactive dashboard highlights alerts, stats, and trends.",
  },
];
      ...
      <div className="max-w-6xl mx-auto text-center">
        ...
        <div className="flex flex-col md:flex-row md:justify-between items-center gap-10 md:gap-0">
          {steps.map((step, index) => (
            <div
              key={index}
              className="relative flex flex-col items-center text-center px-4 md:w-1/4"
            >
